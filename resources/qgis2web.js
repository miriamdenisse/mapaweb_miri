...
map.getView().fit([-8835722.048222, -1613417.186995, -8375305.294156, -1087463.191860], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa Web -  Provincia</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (77 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Elaborado por la alumna de Ing. Ambiental <br />Miriam denisse carhuaricra gabriel';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_miriam_t3provincia_lima_0,
    colName: 'NOMBPROV',
    zoom: 10,
    collapsed: true,
    map: map,
