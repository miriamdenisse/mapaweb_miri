...
var style_miriam_t3lima_ieslistado_iiee_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var labelFont = "9.1px \'Modern No. 20\', sans-serif";
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 0.8000000000000002 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(152,125,183,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(255,255,255,1.0)'})}),
